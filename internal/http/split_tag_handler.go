...
type SplitTagHandler struct {
	svc *split_tag.SplitTagService
}

func NewSplitTagHandler(svc *split_tag.SplitTagService) *SplitTagHandler {
...
func toSplitTagResponse(t split_tag.SplitTag) splitTagResponse {
...
func toSplitTagResponses(tags []split_tag.SplitTag) []splitTagResponse {
...
func toSplitTagMemberResponses(members []split_tag.SplitTagMemberWithUser) []splitTagMemberResponse {
...
func toSplitTagMemberItemResponse(m split_tag.SplitTagMember) splitTagMemberItemResponse {
